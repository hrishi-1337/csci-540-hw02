...
scan 'condiments', {STARTROW => 'Ground beef (95% lean)', ENDROW => 'Breaded fried summer squash',FILTER => SingleColumnValueFilter.new(Bytes.toBytes('identifiers'), Bytes.toBytes('display_name'),
    CompareFilter::CompareOp.valueOf('EQUAL'),SubstringComparator.new('Home fries'))}
